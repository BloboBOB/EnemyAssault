...
ghst_slingload = _heli addAction ["<t shadow='1' color='#ffff00'>Slingload Vehicle</t>", "call ghst_fnc_slingload", [], 5, false, true, "","alive _target and _this == driver _target"];

...
ghst_slingcancel = _heli addAction ["<t shadow='1' color='#ff0000'>Cancel Slingload</t>", "call ghst_fnc_slingcancel", [], 5, false, true, "","alive _target and _this == driver _target"];

ghst_slingattach = _heli addAction ["<t shadow='1' color='#00ff00'>Sling Vehicle</t>", "call ghst_fnc_slingattach", [], 6, true, true, "","alive _target and _this == driver _target and (speed _target < 40) and (speed _target > -40) and (((getposatl _target select 2) < 16 and (getposatl _target select 2) > 10) or ((surfaceIsWater getposasl _target) and ((getposaslw _target select 2) < 16 and (getposaslw _target select 2) > 10)))"];

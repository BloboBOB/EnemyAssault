ghst_c4_array = [];
player addAction ["<t shadow='1' color='#FEE093'>Attach C4</t> <img shadow='1' image='\A3\Weapons_F\Data\UI\gear_c4_charge_small_CA.paa'/>", {
...
player addAction [format ["<t shadow='1' color='#B22222'>Detonate C4 #%1</t> <img size='3' shadow='1' image='\A3\Weapons_F\Data\UI\gear_c4_charge_small_CA.paa'/>", _cn + 1], {
...
ghst_satchel_array = [];
player addAction ["<t shadow='1' color='#FEE093'>Attach Satchel</t> <img size='2' shadow='1' image='\A3\Weapons_f\data\UI\gear_satchel_CA.paa'/>", {
player playActionNow "PutDown";
...
player addAction [format ["<t  shadow='1' color='#B22222'>Detonate Satchel #%1</t> <img size='3' shadow='1' image='\A3\Weapons_f\data\UI\gear_satchel_CA.paa'/>", _sn + 1], {
	_array = _this select 3;
		_explosive = _array select 0;
		_sn = _array select 1;
	player removeAction (_this select 2);
...
player addAction["<t shadow='1' color='#ffa200'>Virtual Ammobox</t>", "VAS\open.sqf", [], 1, false, true, "","alive _target and (getposatl player distance getposatl base) < 150"];

//this addaction ["Open Virtual Arsenal", { ["Open",true] call BIS_fnc_arsenal; }];  
player addaction ["<t shadow='1' color='#ffffff'>Open Virtual Arsenal</t>", { ["Open",true] call BIS_fnc_arsenal; }, [], 1, false, true, "","alive _target and (getposatl player distance getposatl base) < 150"];
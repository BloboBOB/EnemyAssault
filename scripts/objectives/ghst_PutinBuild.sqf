/*
V2.5.5 - By Ghost - coord snippet is from DiRaven
...
null0 = [[1,2,2],[300,300,0],[object1,object2],[markunits (true/false),"color",[50,50]],[6,10,east],aiskill,debug(true)] execvm "ghst_PutinBuild.sqf";
*/

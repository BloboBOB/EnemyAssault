...
//[_position,_radarray,"UH60_wreck_EP1","tsk_crash",[20,20],((paramsArray select 3)/10),[markunits (true/false),"color",[50,50]]] execvm "scripts\objectives\ghst_randomcrash.sqf";
...
_trig1act = format ["[""%1"",'succeeded'] call SHK_Taskmaster_upd; (thislist select 0) addrating 5000; %2 setdamage 1; deleteVehicle %2;", _tsk, _veh];

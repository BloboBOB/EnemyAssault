...
//[_position_mark,_radarray,"O_MBT_02_arty_F",false,((paramsArray select 3)/10),[markunits (true/false),"color",[50,50]]] execvm "scripts\objectives\ghst_randomloc.sqf";
...
//spawn camo net over cache
	if (_usenet) then {
		_vehnet = createVehicle ["CamoNet_OPFOR_big_F",_vehpos, [], 0, "NONE"];
...
_trig1act = format ["%2 setdamage 1; [""%1"",'succeeded'] call SHK_Taskmaster_upd;", _tsk, _veh];
